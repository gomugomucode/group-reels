...
import { Clapperboard, LayoutDashboard, Shield, LogOut, Users, Activity, Video } from "lucide-react";
        ...
        <nav className="flex items-center gap-1">
          ...
          {isAdmin && (
            <>
              ...
              <NavItem to="/admin/video-links" icon={<Video className="size-4" />} label="Videos" />
